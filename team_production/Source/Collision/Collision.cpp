...
void CheckCollision()
{
    // ÉvÉåÉCÉÑÅ[Ç∆É}ÉbÉvÇÃìñÇΩÇËîªíË
...
void ResolvePlayerBlockCollision(BlockData* block)
{
    ...
    // Ç«ÇøÇÁÇÃï˚å¸Ç…ÇﬂÇËçûÇÒÇ≈Ç¢ÇÈÇ©îªíË
    ...
    // â°ï˚å¸ÇÃâüÇµñﬂÇµÇ™è¨Ç≥Ç¢
    if (minOverlapX < minOverlapY)
    {
        if (overlapLeft < overlapRight)
            p->posX = bx - pw;       // ç∂Ç©ÇÁÇ‘Ç¬Ç©Ç¡ÇΩ
        else
            p->posX = bx + bw;       // âEÇ©ÇÁÇ‘Ç¬Ç©Ç¡ÇΩ
...
void ResolveBlockCollision(BlockData& a, BlockData& b)
{
    ...
    const float friction = 0.5f; // ñÄéCåWêî
    ...
    else
    {
        ...
        // ècâüÇµñﬂÇµÇÃÇ∆Ç´Ç…â°ë¨ìxÇ…ñÄéCÇÇ©ÇØÇÈ
        a.vel.x *= friction;
        b.vel.x *= friction;
    }
}

// ìÆÇ≠ÉuÉçÉbÉNìØémÇÃè’ìÀîªíË
